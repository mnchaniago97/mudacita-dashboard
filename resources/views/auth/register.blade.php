...
<head>
    ...
    <title>Register | {{ optional($appSettings)->org_name ?? 'Mudacita Dashboard' }}</title>
        ...
        <div class="auth-cover-sidebar-inner">
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <h4 class="fs-13 fw-bold mb-2">Silahkan Isi Form Untuk Membuat Akun</h4>
                    <p class="fs-12 fw-medium text-muted">Buat akun untuk mulai berkontribusi bersama Muda Cita Indonesia dan mengakses fitur dashboard.</p>

                    @if ($errors->any())
                        <div class="border border-danger bg-white text-danger p-3 rounded mb-3">
                            <div class="fw-bold mb-1">Gagal mendaftar:</div>
                            <ul class="mb-0">
                    ...
                    <form method="POST" action="{{ route('register.process') }}" class="w-100 mt-4 pt-2">
                        ...
                        <div class="mb-4 generate-pass">
                            <div class="input-group field">
                                <input type="password" name="password" class="form-control password" id="newPassword" placeholder="Password Confirm" required>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="termsCondition" name="agree" value="1" required>
