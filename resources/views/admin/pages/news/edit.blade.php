                            ...
                            <div class="card stretch stretch-full">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control" value="{{ old('title', $news->title) }}" placeholder="Masukkan judul artikel" required>
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="excerpt" class="form-control" rows="3" placeholder="Masukkan ringkasan artikel (opsional)">{{ old('excerpt', $news->excerpt) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="content" id="summernote" class="form-control" rows="15">{{ old('content', $news->content) }}</textarea>
                                        @error('content')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div id="image-preview" class="mt-2">
                                            @if($news->image)
                                                <img src="{{ asset('storage/' . $news->image) }}" class="img-thumbnail" style="max-height: 150px;">
                                                <div class="form-check mt-2">
                                                    <input class="form-check-input" type="checkbox" name="remove_image" id="remove_image">
                                                    <label class="form-check-label text-danger" for="remove_image">Hapus gambar</label>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="author_name" class="form-control" value="{{ old('author_name', $news->author_name) }}" placeholder="Nama penulis">
                                    </div>
                                    ...
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" name="is_featured" class="form-check-input" id="is_featured" {{ old('is_featured', $news->is_featured) ? 'checked' : '' }}>
