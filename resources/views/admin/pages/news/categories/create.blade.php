                            ...
                            <div class="card-body">
                                <form action="{{ route('news.categories.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: Pendidikan" required>
                                        @error('name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 flex-wrap">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="color" id="color_{{ $loop->index }}" value="{{ $color }}" {{ old('color') == $color || (!old('color') && $loop->first) ? 'checked' : '' }}>
                                        ...
                                        <input type="text" name="color_custom" class="form-control mt-2" value="{{ old('color_custom') }}" placeholder="Atau masukkan kode warna (#ffffff)">
                                    </div>
