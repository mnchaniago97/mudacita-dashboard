            ...
            <div class="navbar-content">
                <ul class="nxl-navbar">
                        ...
                        <li class="nxl-item nxl-hasmenu">
                            ...
                            <ul class="nxl-submenu">
                                <li class="nxl-item">
                                    <a href="{{ url('/content/home') }}" class="nxl-link">
                                        <span class="nxl-micon"><i class="feather-home"></i></span>
                                        <span class="nxl-mtext">Home</span>
                                    </a>
                                </li>
                                <li class="nxl-item">
                                    <a href="{{ route('content.tentang.show') }}" class="nxl-link">
                                ...
                                <li class="nxl-item nxl-hasmenu">
                                    <a href="javascript:void(0);" class="nxl-link">
                                        ...
                                        <span class="nxl-mtext">Program</span>
                                        <span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                                    </a>
                                    <ul class="nxl-submenu">
                                        <li class="nxl-item">
                                            <a href="{{ route('content.program.show', 'pendidikan') }}" class="nxl-link">
                                                <span class="nxl-mtext">Pendidikan</span>
                                            </a>
                                        </li>
                                        <li class="nxl-item">
                                            <a href="{{ route('content.program.show', 'sosial') }}" class="nxl-link">
                                                <span class="nxl-mtext">Sosial</span>
                                            </a>
                                        </li>
                                        <li class="nxl-item">
                                            <a href="{{ route('content.program.show', 'lingkungan') }}" class="nxl-link">
                                                <span class="nxl-mtext">Lingkungan</span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nxl-item">
                                    <a href="{{ route('content.kontak.show') }}" class="nxl-link">
                                        <span class="nxl-micon"><i class="feather-mail"></i></span>
                                        <span class="nxl-mtext">Kontak</span>
                                    </a>
                                </li>
                                <li class="nxl-item">
                                    <a href="{{ route('news.index') }}" class="nxl-link">
                                        <span class="nxl-micon"><i class="feather-file-text"></i></span>
                                        <span class="nxl-mtext">Artikel & News</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
